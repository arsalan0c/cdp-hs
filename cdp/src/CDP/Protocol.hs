...
data ConsoleConsoleMessageSource = ConsoleConsoleMessageSourceXml | ConsoleConsoleMessageSourceJavascript | ConsoleConsoleMessageSourceNetwork | ConsoleConsoleMessageSourceConsoleApi | ConsoleConsoleMessageSourceStorage | ConsoleConsoleMessageSourceAppcache | ConsoleConsoleMessageSourceRendering | ConsoleConsoleMessageSourceSecurity | ConsoleConsoleMessageSourceOther | ConsoleConsoleMessageSourceDeprecation | ConsoleConsoleMessageSourceWorker
       deriving (Ord, Eq, Show, Read)
instance FromJSON ConsoleConsoleMessageSource where
      parseJSON = A.withText  "ConsoleConsoleMessageSource"  $ \v -> do
            case v of
                  "xml" -> pure $ ConsoleConsoleMessageSourceXml
                  "javascript" -> pure $ ConsoleConsoleMessageSourceJavascript
                  "network" -> pure $ ConsoleConsoleMessageSourceNetwork
                  "console-api" -> pure $ ConsoleConsoleMessageSourceConsoleApi
                  "storage" -> pure $ ConsoleConsoleMessageSourceStorage
                  "appcache" -> pure $ ConsoleConsoleMessageSourceAppcache
                  "rendering" -> pure $ ConsoleConsoleMessageSourceRendering
                  "security" -> pure $ ConsoleConsoleMessageSourceSecurity
                  "other" -> pure $ ConsoleConsoleMessageSourceOther
                  "deprecation" -> pure $ ConsoleConsoleMessageSourceDeprecation
                  "worker" -> pure $ ConsoleConsoleMessageSourceWorker
                  _ -> fail "failed to parse ConsoleConsoleMessageSource"

instance ToJSON ConsoleConsoleMessageSource where
      toJSON v = A.String $
            case v of
                  ConsoleConsoleMessageSourceXml -> "xml"
                  ConsoleConsoleMessageSourceJavascript -> "javascript"
                  ConsoleConsoleMessageSourceNetwork -> "network"
                  ConsoleConsoleMessageSourceConsoleApi -> "console-api"
                  ConsoleConsoleMessageSourceStorage -> "storage"
                  ConsoleConsoleMessageSourceAppcache -> "appcache"
                  ConsoleConsoleMessageSourceRendering -> "rendering"
                  ConsoleConsoleMessageSourceSecurity -> "security"
                  ConsoleConsoleMessageSourceOther -> "other"
                  ConsoleConsoleMessageSourceDeprecation -> "deprecation"
                  ConsoleConsoleMessageSourceWorker -> "worker"


data ConsoleConsoleMessageLevel = ConsoleConsoleMessageLevelLog | ConsoleConsoleMessageLevelWarning | ConsoleConsoleMessageLevelError | ConsoleConsoleMessageLevelDebug | ConsoleConsoleMessageLevelInfo
       deriving (Ord, Eq, Show, Read)
instance FromJSON ConsoleConsoleMessageLevel where
      parseJSON = A.withText  "ConsoleConsoleMessageLevel"  $ \v -> do
            case v of
                  "log" -> pure $ ConsoleConsoleMessageLevelLog
                  "warning" -> pure $ ConsoleConsoleMessageLevelWarning
                  "error" -> pure $ ConsoleConsoleMessageLevelError
                  "debug" -> pure $ ConsoleConsoleMessageLevelDebug
                  "info" -> pure $ ConsoleConsoleMessageLevelInfo
                  _ -> fail "failed to parse ConsoleConsoleMessageLevel"

instance ToJSON ConsoleConsoleMessageLevel where
      toJSON v = A.String $
            case v of
                  ConsoleConsoleMessageLevelLog -> "log"
                  ConsoleConsoleMessageLevelWarning -> "warning"
                  ConsoleConsoleMessageLevelError -> "error"
                  ConsoleConsoleMessageLevelDebug -> "debug"
                  ConsoleConsoleMessageLevelInfo -> "info"



data ConsoleConsoleMessage = ConsoleConsoleMessage {
      consoleConsoleMessageSource :: ConsoleConsoleMessageSource,
      consoleConsoleMessageLevel :: ConsoleConsoleMessageLevel,
...
type PDebuggerEnable = [(String, String)]
...
type PDebuggerStepInto = [(String, String)]
...
type PDebuggerStepOver = [(String, String)]
