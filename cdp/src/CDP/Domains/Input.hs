...
data InputDragDataItem = InputDragDataItem {
  ...
  inputDragDataItemMimeType :: Text,
  -- | Depending of the value of `mimeType`, it contains the dragged link,
  --   text, HTML markup or any other data.
  inputDragDataItemData :: Text,
  -- | Title associated with a link. Only valid when `mimeType` == "text/uri-list".
  inputDragDataItemTitle :: Maybe Text,
  -- | Stores the base URL for the contained markup. Only valid when `mimeType`
  --   == "text/html".
  inputDragDataItemBaseUrl :: Maybe Text
} deriving (Generic, Eq, Show, Read)
...
data PInputImeSetComposition = PInputImeSetComposition {
  -- | The text to insert
  pInputImeSetCompositionText :: Text,
  -- | selection start
