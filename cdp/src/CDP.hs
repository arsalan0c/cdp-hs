...
instance FromJSON (EventResponse Event ) where
   parseJSON = A.withObject  "EventResponse"  $ \obj -> do
       ...
       case (name :: String) of
           "Accessibility.loadComplete" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Accessibility.AccessibilityLoadComplete) sessionId . fmap EVAccessibilityLoadComplete <$> obj .:? "params"
           "Accessibility.nodesUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Accessibility.AccessibilityNodesUpdated) sessionId . fmap EVAccessibilityNodesUpdated <$> obj .:? "params"
           "Animation.animationCanceled" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Animation.AnimationAnimationCanceled) sessionId . fmap EVAnimationAnimationCanceled <$> obj .:? "params"
           "Animation.animationCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Animation.AnimationAnimationCreated) sessionId . fmap EVAnimationAnimationCreated <$> obj .:? "params"
           "Animation.animationStarted" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Animation.AnimationAnimationStarted) sessionId . fmap EVAnimationAnimationStarted <$> obj .:? "params"
           "Audits.issueAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Audits.AuditsIssueAdded) sessionId . fmap EVAuditsIssueAdded <$> obj .:? "params"
           "BackgroundService.recordingStateChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BackgroundService.BackgroundServiceRecordingStateChanged) sessionId . fmap EVBackgroundServiceRecordingStateChanged <$> obj .:? "params"
           "BackgroundService.backgroundServiceEventReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BackgroundService.BackgroundServiceBackgroundServiceEventReceived) sessionId . fmap EVBackgroundServiceBackgroundServiceEventReceived <$> obj .:? "params"
           "Browser.downloadWillBegin" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.BrowserDownloadWillBegin) sessionId . fmap EVBrowserDownloadWillBegin <$> obj .:? "params"
           "Browser.downloadProgress" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.BrowserDownloadProgress) sessionId . fmap EVBrowserDownloadProgress <$> obj .:? "params"
           "CSS.fontsUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy CSS.CssFontsUpdated) sessionId . fmap EVCssFontsUpdated <$> obj .:? "params"
           "CSS.mediaQueryResultChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy CSS.CssMediaQueryResultChanged) sessionId . fmap EVCssMediaQueryResultChanged <$> obj .:? "params"
           "CSS.styleSheetAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy CSS.CssStyleSheetAdded) sessionId . fmap EVCssStyleSheetAdded <$> obj .:? "params"
           "CSS.styleSheetChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy CSS.CssStyleSheetChanged) sessionId . fmap EVCssStyleSheetChanged <$> obj .:? "params"
           "CSS.styleSheetRemoved" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy CSS.CssStyleSheetRemoved) sessionId . fmap EVCssStyleSheetRemoved <$> obj .:? "params"
           "Cast.sinksUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Cast.CastSinksUpdated) sessionId . fmap EVCastSinksUpdated <$> obj .:? "params"
           "Cast.issueUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Cast.CastIssueUpdated) sessionId . fmap EVCastIssueUpdated <$> obj .:? "params"
           "DOM.attributeModified" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomAttributeModified) sessionId . fmap EVDomAttributeModified <$> obj .:? "params"
           "DOM.attributeRemoved" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomAttributeRemoved) sessionId . fmap EVDomAttributeRemoved <$> obj .:? "params"
           "DOM.characterDataModified" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomCharacterDataModified) sessionId . fmap EVDomCharacterDataModified <$> obj .:? "params"
           "DOM.childNodeCountUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomChildNodeCountUpdated) sessionId . fmap EVDomChildNodeCountUpdated <$> obj .:? "params"
           "DOM.childNodeInserted" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomChildNodeInserted) sessionId . fmap EVDomChildNodeInserted <$> obj .:? "params"
           "DOM.childNodeRemoved" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomChildNodeRemoved) sessionId . fmap EVDomChildNodeRemoved <$> obj .:? "params"
           "DOM.distributedNodesUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomDistributedNodesUpdated) sessionId . fmap EVDomDistributedNodesUpdated <$> obj .:? "params"
           "DOM.documentUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomDocumentUpdated) sessionId . fmap EVDomDocumentUpdated <$> obj .:? "params"
           "DOM.inlineStyleInvalidated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomInlineStyleInvalidated) sessionId . fmap EVDomInlineStyleInvalidated <$> obj .:? "params"
           "DOM.pseudoElementAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomPseudoElementAdded) sessionId . fmap EVDomPseudoElementAdded <$> obj .:? "params"
           "DOM.pseudoElementRemoved" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomPseudoElementRemoved) sessionId . fmap EVDomPseudoElementRemoved <$> obj .:? "params"
           "DOM.setChildNodes" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomSetChildNodes) sessionId . fmap EVDomSetChildNodes <$> obj .:? "params"
           "DOM.shadowRootPopped" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomShadowRootPopped) sessionId . fmap EVDomShadowRootPopped <$> obj .:? "params"
           "DOM.shadowRootPushed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.DomShadowRootPushed) sessionId . fmap EVDomShadowRootPushed <$> obj .:? "params"
           "DOMStorage.domStorageItemAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMStorage.DomStorageDomStorageItemAdded) sessionId . fmap EVDomStorageDomStorageItemAdded <$> obj .:? "params"
           "DOMStorage.domStorageItemRemoved" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMStorage.DomStorageDomStorageItemRemoved) sessionId . fmap EVDomStorageDomStorageItemRemoved <$> obj .:? "params"
           "DOMStorage.domStorageItemUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMStorage.DomStorageDomStorageItemUpdated) sessionId . fmap EVDomStorageDomStorageItemUpdated <$> obj .:? "params"
           "DOMStorage.domStorageItemsCleared" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMStorage.DomStorageDomStorageItemsCleared) sessionId . fmap EVDomStorageDomStorageItemsCleared <$> obj .:? "params"
           "Database.addDatabase" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Database.DatabaseAddDatabase) sessionId . fmap EVDatabaseAddDatabase <$> obj .:? "params"
           "Emulation.virtualTimeBudgetExpired" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.EmulationVirtualTimeBudgetExpired) sessionId . fmap EVEmulationVirtualTimeBudgetExpired <$> obj .:? "params"
           "Input.dragIntercepted" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Input.InputDragIntercepted) sessionId . fmap EVInputDragIntercepted <$> obj .:? "params"
           "Inspector.detached" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Inspector.InspectorDetached) sessionId . fmap EVInspectorDetached <$> obj .:? "params"
           "Inspector.targetCrashed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Inspector.InspectorTargetCrashed) sessionId . fmap EVInspectorTargetCrashed <$> obj .:? "params"
           "Inspector.targetReloadedAfterCrash" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Inspector.InspectorTargetReloadedAfterCrash) sessionId . fmap EVInspectorTargetReloadedAfterCrash <$> obj .:? "params"
           "LayerTree.layerPainted" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy LayerTree.LayerTreeLayerPainted) sessionId . fmap EVLayerTreeLayerPainted <$> obj .:? "params"
           "LayerTree.layerTreeDidChange" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy LayerTree.LayerTreeLayerTreeDidChange) sessionId . fmap EVLayerTreeLayerTreeDidChange <$> obj .:? "params"
           "Log.entryAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Log.LogEntryAdded) sessionId . fmap EVLogEntryAdded <$> obj .:? "params"
           "Network.dataReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkDataReceived) sessionId . fmap EVNetworkDataReceived <$> obj .:? "params"
           "Network.eventSourceMessageReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkEventSourceMessageReceived) sessionId . fmap EVNetworkEventSourceMessageReceived <$> obj .:? "params"
           "Network.loadingFailed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkLoadingFailed) sessionId . fmap EVNetworkLoadingFailed <$> obj .:? "params"
           "Network.loadingFinished" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkLoadingFinished) sessionId . fmap EVNetworkLoadingFinished <$> obj .:? "params"
           "Network.requestServedFromCache" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkRequestServedFromCache) sessionId . fmap EVNetworkRequestServedFromCache <$> obj .:? "params"
           "Network.requestWillBeSent" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkRequestWillBeSent) sessionId . fmap EVNetworkRequestWillBeSent <$> obj .:? "params"
           "Network.resourceChangedPriority" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkResourceChangedPriority) sessionId . fmap EVNetworkResourceChangedPriority <$> obj .:? "params"
           "Network.signedExchangeReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkSignedExchangeReceived) sessionId . fmap EVNetworkSignedExchangeReceived <$> obj .:? "params"
           "Network.responseReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkResponseReceived) sessionId . fmap EVNetworkResponseReceived <$> obj .:? "params"
           "Network.webSocketClosed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebSocketClosed) sessionId . fmap EVNetworkWebSocketClosed <$> obj .:? "params"
           "Network.webSocketCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebSocketCreated) sessionId . fmap EVNetworkWebSocketCreated <$> obj .:? "params"
           "Network.webSocketFrameError" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebSocketFrameError) sessionId . fmap EVNetworkWebSocketFrameError <$> obj .:? "params"
           "Network.webSocketFrameReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebSocketFrameReceived) sessionId . fmap EVNetworkWebSocketFrameReceived <$> obj .:? "params"
           "Network.webSocketFrameSent" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebSocketFrameSent) sessionId . fmap EVNetworkWebSocketFrameSent <$> obj .:? "params"
           "Network.webSocketHandshakeResponseReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebSocketHandshakeResponseReceived) sessionId . fmap EVNetworkWebSocketHandshakeResponseReceived <$> obj .:? "params"
           "Network.webSocketWillSendHandshakeRequest" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebSocketWillSendHandshakeRequest) sessionId . fmap EVNetworkWebSocketWillSendHandshakeRequest <$> obj .:? "params"
           "Network.webTransportCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebTransportCreated) sessionId . fmap EVNetworkWebTransportCreated <$> obj .:? "params"
           "Network.webTransportConnectionEstablished" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebTransportConnectionEstablished) sessionId . fmap EVNetworkWebTransportConnectionEstablished <$> obj .:? "params"
           "Network.webTransportClosed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkWebTransportClosed) sessionId . fmap EVNetworkWebTransportClosed <$> obj .:? "params"
           "Network.requestWillBeSentExtraInfo" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkRequestWillBeSentExtraInfo) sessionId . fmap EVNetworkRequestWillBeSentExtraInfo <$> obj .:? "params"
           "Network.responseReceivedExtraInfo" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkResponseReceivedExtraInfo) sessionId . fmap EVNetworkResponseReceivedExtraInfo <$> obj .:? "params"
           "Network.trustTokenOperationDone" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkTrustTokenOperationDone) sessionId . fmap EVNetworkTrustTokenOperationDone <$> obj .:? "params"
           "Network.subresourceWebBundleMetadataReceived" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkSubresourceWebBundleMetadataReceived) sessionId . fmap EVNetworkSubresourceWebBundleMetadataReceived <$> obj .:? "params"
           "Network.subresourceWebBundleMetadataError" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkSubresourceWebBundleMetadataError) sessionId . fmap EVNetworkSubresourceWebBundleMetadataError <$> obj .:? "params"
           "Network.subresourceWebBundleInnerResponseParsed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkSubresourceWebBundleInnerResponseParsed) sessionId . fmap EVNetworkSubresourceWebBundleInnerResponseParsed <$> obj .:? "params"
           "Network.subresourceWebBundleInnerResponseError" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkSubresourceWebBundleInnerResponseError) sessionId . fmap EVNetworkSubresourceWebBundleInnerResponseError <$> obj .:? "params"
           "Network.reportingApiReportAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkReportingApiReportAdded) sessionId . fmap EVNetworkReportingApiReportAdded <$> obj .:? "params"
           "Network.reportingApiReportUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkReportingApiReportUpdated) sessionId . fmap EVNetworkReportingApiReportUpdated <$> obj .:? "params"
           "Network.reportingApiEndpointsChangedForOrigin" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.NetworkReportingApiEndpointsChangedForOrigin) sessionId . fmap EVNetworkReportingApiEndpointsChangedForOrigin <$> obj .:? "params"
           "Overlay.inspectNodeRequested" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Overlay.OverlayInspectNodeRequested) sessionId . fmap EVOverlayInspectNodeRequested <$> obj .:? "params"
           "Overlay.nodeHighlightRequested" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Overlay.OverlayNodeHighlightRequested) sessionId . fmap EVOverlayNodeHighlightRequested <$> obj .:? "params"
           "Overlay.screenshotRequested" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Overlay.OverlayScreenshotRequested) sessionId . fmap EVOverlayScreenshotRequested <$> obj .:? "params"
           "Overlay.inspectModeCanceled" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Overlay.OverlayInspectModeCanceled) sessionId . fmap EVOverlayInspectModeCanceled <$> obj .:? "params"
           "Page.domContentEventFired" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageDomContentEventFired) sessionId . fmap EVPageDomContentEventFired <$> obj .:? "params"
           "Page.fileChooserOpened" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFileChooserOpened) sessionId . fmap EVPageFileChooserOpened <$> obj .:? "params"
           "Page.frameAttached" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFrameAttached) sessionId . fmap EVPageFrameAttached <$> obj .:? "params"
           "Page.frameDetached" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFrameDetached) sessionId . fmap EVPageFrameDetached <$> obj .:? "params"
           "Page.frameNavigated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFrameNavigated) sessionId . fmap EVPageFrameNavigated <$> obj .:? "params"
           "Page.documentOpened" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageDocumentOpened) sessionId . fmap EVPageDocumentOpened <$> obj .:? "params"
           "Page.frameResized" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFrameResized) sessionId . fmap EVPageFrameResized <$> obj .:? "params"
           "Page.frameRequestedNavigation" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFrameRequestedNavigation) sessionId . fmap EVPageFrameRequestedNavigation <$> obj .:? "params"
           "Page.frameStartedLoading" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFrameStartedLoading) sessionId . fmap EVPageFrameStartedLoading <$> obj .:? "params"
           "Page.frameStoppedLoading" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageFrameStoppedLoading) sessionId . fmap EVPageFrameStoppedLoading <$> obj .:? "params"
           "Page.interstitialHidden" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageInterstitialHidden) sessionId . fmap EVPageInterstitialHidden <$> obj .:? "params"
           "Page.interstitialShown" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageInterstitialShown) sessionId . fmap EVPageInterstitialShown <$> obj .:? "params"
           "Page.javascriptDialogClosed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageJavascriptDialogClosed) sessionId . fmap EVPageJavascriptDialogClosed <$> obj .:? "params"
           "Page.javascriptDialogOpening" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageJavascriptDialogOpening) sessionId . fmap EVPageJavascriptDialogOpening <$> obj .:? "params"
           "Page.lifecycleEvent" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageLifecycleEvent) sessionId . fmap EVPageLifecycleEvent <$> obj .:? "params"
           "Page.backForwardCacheNotUsed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageBackForwardCacheNotUsed) sessionId . fmap EVPageBackForwardCacheNotUsed <$> obj .:? "params"
           "Page.prerenderAttemptCompleted" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PagePrerenderAttemptCompleted) sessionId . fmap EVPagePrerenderAttemptCompleted <$> obj .:? "params"
           "Page.loadEventFired" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageLoadEventFired) sessionId . fmap EVPageLoadEventFired <$> obj .:? "params"
           "Page.navigatedWithinDocument" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageNavigatedWithinDocument) sessionId . fmap EVPageNavigatedWithinDocument <$> obj .:? "params"
           "Page.screencastFrame" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageScreencastFrame) sessionId . fmap EVPageScreencastFrame <$> obj .:? "params"
           "Page.screencastVisibilityChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageScreencastVisibilityChanged) sessionId . fmap EVPageScreencastVisibilityChanged <$> obj .:? "params"
           "Page.windowOpen" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageWindowOpen) sessionId . fmap EVPageWindowOpen <$> obj .:? "params"
           "Page.compilationCacheProduced" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.PageCompilationCacheProduced) sessionId . fmap EVPageCompilationCacheProduced <$> obj .:? "params"
           "Performance.metrics" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Performance.PerformanceMetrics) sessionId . fmap EVPerformanceMetrics <$> obj .:? "params"
           "PerformanceTimeline.timelineEventAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy PerformanceTimeline.PerformanceTimelineTimelineEventAdded) sessionId . fmap EVPerformanceTimelineTimelineEventAdded <$> obj .:? "params"
           "Security.visibleSecurityStateChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy DOMPageNetworkEmulationSecurity.SecurityVisibleSecurityStateChanged) sessionId . fmap EVSecurityVisibleSecurityStateChanged <$> obj .:? "params"
           "ServiceWorker.workerErrorReported" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy ServiceWorker.ServiceWorkerWorkerErrorReported) sessionId . fmap EVServiceWorkerWorkerErrorReported <$> obj .:? "params"
           "ServiceWorker.workerRegistrationUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy ServiceWorker.ServiceWorkerWorkerRegistrationUpdated) sessionId . fmap EVServiceWorkerWorkerRegistrationUpdated <$> obj .:? "params"
           "ServiceWorker.workerVersionUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy ServiceWorker.ServiceWorkerWorkerVersionUpdated) sessionId . fmap EVServiceWorkerWorkerVersionUpdated <$> obj .:? "params"
           "Storage.cacheStorageContentUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Storage.StorageCacheStorageContentUpdated) sessionId . fmap EVStorageCacheStorageContentUpdated <$> obj .:? "params"
           "Storage.cacheStorageListUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Storage.StorageCacheStorageListUpdated) sessionId . fmap EVStorageCacheStorageListUpdated <$> obj .:? "params"
           "Storage.indexedDBContentUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Storage.StorageIndexedDbContentUpdated) sessionId . fmap EVStorageIndexedDbContentUpdated <$> obj .:? "params"
           "Storage.indexedDBListUpdated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Storage.StorageIndexedDbListUpdated) sessionId . fmap EVStorageIndexedDbListUpdated <$> obj .:? "params"
           "Storage.interestGroupAccessed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Storage.StorageInterestGroupAccessed) sessionId . fmap EVStorageInterestGroupAccessed <$> obj .:? "params"
           "Target.attachedToTarget" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.TargetAttachedToTarget) sessionId . fmap EVTargetAttachedToTarget <$> obj .:? "params"
           "Target.detachedFromTarget" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.TargetDetachedFromTarget) sessionId . fmap EVTargetDetachedFromTarget <$> obj .:? "params"
           "Target.receivedMessageFromTarget" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.TargetReceivedMessageFromTarget) sessionId . fmap EVTargetReceivedMessageFromTarget <$> obj .:? "params"
           "Target.targetCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.TargetTargetCreated) sessionId . fmap EVTargetTargetCreated <$> obj .:? "params"
           "Target.targetDestroyed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.TargetTargetDestroyed) sessionId . fmap EVTargetTargetDestroyed <$> obj .:? "params"
           "Target.targetCrashed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.TargetTargetCrashed) sessionId . fmap EVTargetTargetCrashed <$> obj .:? "params"
           "Target.targetInfoChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy BrowserTarget.TargetTargetInfoChanged) sessionId . fmap EVTargetTargetInfoChanged <$> obj .:? "params"
           "Tethering.accepted" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Tethering.TetheringAccepted) sessionId . fmap EVTetheringAccepted <$> obj .:? "params"
           "Tracing.bufferUsage" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Tracing.TracingBufferUsage) sessionId . fmap EVTracingBufferUsage <$> obj .:? "params"
           "Tracing.dataCollected" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Tracing.TracingDataCollected) sessionId . fmap EVTracingDataCollected <$> obj .:? "params"
           "Tracing.tracingComplete" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Tracing.TracingTracingComplete) sessionId . fmap EVTracingTracingComplete <$> obj .:? "params"
           "Fetch.requestPaused" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Fetch.FetchRequestPaused) sessionId . fmap EVFetchRequestPaused <$> obj .:? "params"
           "Fetch.authRequired" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Fetch.FetchAuthRequired) sessionId . fmap EVFetchAuthRequired <$> obj .:? "params"
           "WebAudio.contextCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioContextCreated) sessionId . fmap EVWebAudioContextCreated <$> obj .:? "params"
           "WebAudio.contextWillBeDestroyed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioContextWillBeDestroyed) sessionId . fmap EVWebAudioContextWillBeDestroyed <$> obj .:? "params"
           "WebAudio.contextChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioContextChanged) sessionId . fmap EVWebAudioContextChanged <$> obj .:? "params"
           "WebAudio.audioListenerCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioAudioListenerCreated) sessionId . fmap EVWebAudioAudioListenerCreated <$> obj .:? "params"
           "WebAudio.audioListenerWillBeDestroyed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioAudioListenerWillBeDestroyed) sessionId . fmap EVWebAudioAudioListenerWillBeDestroyed <$> obj .:? "params"
           "WebAudio.audioNodeCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioAudioNodeCreated) sessionId . fmap EVWebAudioAudioNodeCreated <$> obj .:? "params"
           "WebAudio.audioNodeWillBeDestroyed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioAudioNodeWillBeDestroyed) sessionId . fmap EVWebAudioAudioNodeWillBeDestroyed <$> obj .:? "params"
           "WebAudio.audioParamCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioAudioParamCreated) sessionId . fmap EVWebAudioAudioParamCreated <$> obj .:? "params"
           "WebAudio.audioParamWillBeDestroyed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioAudioParamWillBeDestroyed) sessionId . fmap EVWebAudioAudioParamWillBeDestroyed <$> obj .:? "params"
           "WebAudio.nodesConnected" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioNodesConnected) sessionId . fmap EVWebAudioNodesConnected <$> obj .:? "params"
           "WebAudio.nodesDisconnected" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioNodesDisconnected) sessionId . fmap EVWebAudioNodesDisconnected <$> obj .:? "params"
           "WebAudio.nodeParamConnected" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioNodeParamConnected) sessionId . fmap EVWebAudioNodeParamConnected <$> obj .:? "params"
           "WebAudio.nodeParamDisconnected" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy WebAudio.WebAudioNodeParamDisconnected) sessionId . fmap EVWebAudioNodeParamDisconnected <$> obj .:? "params"
           "Media.playerPropertiesChanged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Media.MediaPlayerPropertiesChanged) sessionId . fmap EVMediaPlayerPropertiesChanged <$> obj .:? "params"
           "Media.playerEventsAdded" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Media.MediaPlayerEventsAdded) sessionId . fmap EVMediaPlayerEventsAdded <$> obj .:? "params"
           "Media.playerMessagesLogged" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Media.MediaPlayerMessagesLogged) sessionId . fmap EVMediaPlayerMessagesLogged <$> obj .:? "params"
           "Media.playerErrorsRaised" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Media.MediaPlayerErrorsRaised) sessionId . fmap EVMediaPlayerErrorsRaised <$> obj .:? "params"
           "Media.playersCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Media.MediaPlayersCreated) sessionId . fmap EVMediaPlayersCreated <$> obj .:? "params"
           "Debugger.breakpointResolved" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Debugger.DebuggerBreakpointResolved) sessionId . fmap EVDebuggerBreakpointResolved <$> obj .:? "params"
           "Debugger.paused" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Debugger.DebuggerPaused) sessionId . fmap EVDebuggerPaused <$> obj .:? "params"
           "Debugger.resumed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Debugger.DebuggerResumed) sessionId . fmap EVDebuggerResumed <$> obj .:? "params"
           "Debugger.scriptFailedToParse" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Debugger.DebuggerScriptFailedToParse) sessionId . fmap EVDebuggerScriptFailedToParse <$> obj .:? "params"
           "Debugger.scriptParsed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Debugger.DebuggerScriptParsed) sessionId . fmap EVDebuggerScriptParsed <$> obj .:? "params"
           "HeapProfiler.addHeapSnapshotChunk" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy HeapProfiler.HeapProfilerAddHeapSnapshotChunk) sessionId . fmap EVHeapProfilerAddHeapSnapshotChunk <$> obj .:? "params"
           "HeapProfiler.heapStatsUpdate" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy HeapProfiler.HeapProfilerHeapStatsUpdate) sessionId . fmap EVHeapProfilerHeapStatsUpdate <$> obj .:? "params"
           "HeapProfiler.lastSeenObjectId" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy HeapProfiler.HeapProfilerLastSeenObjectId) sessionId . fmap EVHeapProfilerLastSeenObjectId <$> obj .:? "params"
           "HeapProfiler.reportHeapSnapshotProgress" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy HeapProfiler.HeapProfilerReportHeapSnapshotProgress) sessionId . fmap EVHeapProfilerReportHeapSnapshotProgress <$> obj .:? "params"
           "HeapProfiler.resetProfiles" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy HeapProfiler.HeapProfilerResetProfiles) sessionId . fmap EVHeapProfilerResetProfiles <$> obj .:? "params"
           "Profiler.consoleProfileFinished" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Profiler.ProfilerConsoleProfileFinished) sessionId . fmap EVProfilerConsoleProfileFinished <$> obj .:? "params"
           "Profiler.consoleProfileStarted" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Profiler.ProfilerConsoleProfileStarted) sessionId . fmap EVProfilerConsoleProfileStarted <$> obj .:? "params"
           "Profiler.preciseCoverageDeltaUpdate" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Profiler.ProfilerPreciseCoverageDeltaUpdate) sessionId . fmap EVProfilerPreciseCoverageDeltaUpdate <$> obj .:? "params"
           "Runtime.bindingCalled" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeBindingCalled) sessionId . fmap EVRuntimeBindingCalled <$> obj .:? "params"
           "Runtime.consoleAPICalled" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeConsoleApiCalled) sessionId . fmap EVRuntimeConsoleApiCalled <$> obj .:? "params"
           "Runtime.exceptionRevoked" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeExceptionRevoked) sessionId . fmap EVRuntimeExceptionRevoked <$> obj .:? "params"
           "Runtime.exceptionThrown" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeExceptionThrown) sessionId . fmap EVRuntimeExceptionThrown <$> obj .:? "params"
           "Runtime.executionContextCreated" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeExecutionContextCreated) sessionId . fmap EVRuntimeExecutionContextCreated <$> obj .:? "params"
           "Runtime.executionContextDestroyed" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeExecutionContextDestroyed) sessionId . fmap EVRuntimeExecutionContextDestroyed <$> obj .:? "params"
           "Runtime.executionContextsCleared" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeExecutionContextsCleared) sessionId . fmap EVRuntimeExecutionContextsCleared <$> obj .:? "params"
           "Runtime.inspectRequested" -> EventResponse (Proxy :: Proxy Event) (Proxy :: Proxy Runtime.RuntimeInspectRequested) sessionId . fmap EVRuntimeInspectRequested <$> obj .:? "params"
